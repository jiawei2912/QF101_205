...
from PyUI import AppPageUI_SimpleInterest

# Each AppModule needs to have:
#   self.title: display name of the module
class SimpleInterestCalculator(QtWidgets.QWidget):
    def __init__(self) -> None:
        super().__init__()
        self.title:str = "Simple Interest"
        self.ui = AppPageUI_SimpleInterest.Ui_ModulePage()
    ...
    def _calculateButtonClickedCallback(self):
        try:
            ...
            finalPrincipal = principal*(1+rate*numPeriods)
